...
(function () {
  ...
  module.exports = {
    ...
    createComplicatedQuery: function (arr) {
      ...
      str = "SELECT p.ID as id, p.Description AS description, p.Price as price, p.Numbers AS numbers, p.stock as stock, p.ordered as ordered, p.link as link, p.msk as msk from inventory1s as p where (" + str + ")";
